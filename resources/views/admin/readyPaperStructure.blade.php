                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form autocomplete="off" id="addPaperStructure" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-4 form-group">
                                    <label for="view_board_name" class="col-form-label"><b>Board:</b></label>
                                    <span id="view_board_name"></span>
                                </div>
                                <div class="col-md-4 form-group">
                                    <label for="view_medium_name" class="col-form-label"><b>Medium:</b></label>
                                    <span id="view_medium_name"></span>
                                </div>
                                <div class="col-md-4 form-group">
                                    <label for="view_class_name" class="col-form-label"><b>Class:</b></label>
                                    <span id="view_class_name"></span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 form-group">
                                    <label for="view_subject_name" class="col-form-label"><b>Subject:</b></label>
                                    <span id="view_subject_name"></span>
                                </div>
                                <div class="col-md-4 form-group">
                                    <label for="view_paper_type" class="col-form-label"><b>Paper Type:</b></label>
                                    <span id="view_paper_type"></span>
                                </div>
                                <div class="col-md-4 form-group">
                                    <label for="view_total_paper_marks" class="col-form-label"><b>Total Paper Marks:</b></label>
                                    <span id="view_total_paper_marks"></span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 form-group">
                                    <label for="view_question_type" class="col-form-label"><b>Question Type:</b></label>
                                    <span id="view_question_type"></span>
                                </div>                           
                                <div class="col-md-4 form-group">
                                    <label for="view_total_marks_as_per_question_type" class="col-form-label"><b>Total Marks As Per Question Type:</b></label>
                                    <span id="view_total_marks_as_per_question_type"></span>
                                </div>
                                <div class="col-md-4 form-group">
                                    <label for="view_marks_per_each_question" class="col-form-label"><b>Marks Per Each Question:</b></label>
                                    <span id="view_marks_per_each_question"></span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 form-group">
                                    <label for="view_total_no_of_questions_to_ask" class="col-form-label"><b>Total No. Of Questions To Ask:</b></label>
                                    <span id="view_total_no_of_questions_to_ask"></span>
                                </div>                            
                                <div class="col-md-4 form-group">
                                    <label for="view_total_no_of_questions_to_ans" class="col-form-label"><b>Total No. Of Questions To Answer:</b></label>
                                    <span id="view_total_no_of_questions_to_ans"></span>
                                </div>
                                <div class="col-md-4 form-group">
                                    <label for="view_question_type_order" class="col-form-label"><b>Question Type Order in Paper:</b></label>
                                    <span id="view_question_type_order"></span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 form-group">
                                    <label for="view_sections" class="col-form-label"><b>Sections:</b></label>
                                    <span id="view_sections"></span>
                                </div>
                                <div class="col-md-4 form-group">
                                    <label for="view_sections_name" class="col-form-label"><b>Sections Name:</b></label>
                                    <span id="view_sections_name"></span>
                                </div>
                                <div class="col-md-4 form-group">
                                    <label for="view_sub_question_type_order" class="col-form-label"><b>Sub Question Order in Paper:</b></label>
                                    <span id="view_sub_question_type_order"></span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 form-group">
                                    <label for="view_child_sub_question_type_order" class="col-form-label"><b>Child Sub Question Order in Paper:</b></label>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#paperStructureModal').on('show.bs.modal', function () {
        ...
        $(document).on('click', '.view', function(){
            ...
            $.ajax({
                ...
                success:function(data)
                {
                    ...
                    // Paper Type
                    $('#view_paper_type').html("<br/>"+data.paper_type);
