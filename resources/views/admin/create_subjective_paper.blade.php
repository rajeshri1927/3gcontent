        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                <div class="page-header-title">
                    <h5 class="m-b-10">Create Subjective Paper</h5>
                </div>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
                    <li class="breadcrumb-item"><a href="#!">Create Subjective Paper Info</a></li>
                    <li class="breadcrumb-item"><a href="#!">Create Subjective Paper Details</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            ...
            <form autocomplete="off" id="addSubjectivePaper" method="post">
                <div class="card-body">
                    {{ csrf_field() }}
                    ...
                    <div class="row mcqPaperOtherData">                            
                        <div class="col-md-3 form-group">
                            ...
                            <input type="text" class="form-control form-control-sm hasDatepicker" id="datepicker" placeholder="Select Date" name="paper_date">
                        </div>
                        <div class="col-md-3 form-group">
                            <label for="paper_marks" class="col-form-label"> Select Marks:</label>
                            <select class="form-control formField" name="paper_marks" id="paper_marks">
                                <option value="">--- Select Marks ---</option>
                            </select>
                        </div>
                        <div class="col-md-3 form-group" id="paperTime">
                            <label for="paper_time" class="col-form-label"> Paper time:</label>
                            <input type="text" class="form-control form-control-sm" id="paper_time" placeholder="Select Time" name="paper_time" readonly="readonly">
                        </div>
                    </div>
                    <div class="row mcqPaperOtherData">
                    ...
                    <div style="text-align:center;">
                    <input type="hidden" name="subjective_paper_id" id="subjective_paper_id" value="" />
...
$(document).ready(function() {
    ...
    $('#subject_id').on('change', function(event){ 
        ...
        if(board_id=="BOARD_BF9351DAA")
        {
            ...
            var mySelect = $('#paper_marks');
            $.each(myOptions, function(val, text) {
                mySelect.append(
                    $('<option></option>').val(text).html(text)
                );
            });
        } else if (board_id=="BOARD_33E77AEF9") {
            var mediumId=$('#filtermedium').val();
            var subjectName=$(this).find(':selected').text();
            if(mediumId=="MED_DB20C156D75" || mediumId=="MED_FA3D096B177") // For English & Hindi Medium
                {
                    var myOptions = {
                        val1 : '',
                        val2 : '20',
                    ...
                    if(subjectName=="English" || subjectName=="Hindi" || subjectName=="Marathi")
                    {
                        var myOptions = {
                            val1 : '',
                            val2 : '25',
            ...
            if(mediumId=="MED_690B302818B") // For 11 12th Commerce
            {
                var myOptions = {
                    val1 : '',
                    val2 : '20',
            ...
            if(mediumId=="MED_B1F3D8DC4AC" || mediumId=="MED_690B302818B"){
                if(subjectName=="Maths 2" || subjectName=="Maths 1" || subjectName=="Maths"){
                    var myOptions = {
                        val1 : '',
                        val2 : '20',
                        val3 : '25',
                ...
                if(subjectName=="Maths1" || subjectName=="Maths2" || subjectName=="Maths"){
                    var myOptions = {
                        val1 : '',
                        val2 : '20',
                        val3 : '25',
                ...
                } else if(subjectName=="Physics" || subjectName=="Chemistry" || subjectName=="Biology") // For 11 12th Science
                {
                    var myOptions = {
                    val1 : '',
                    val2 : '25',
          ...
          $('#paper_marks').empty();
          $("#paper_time_section").hide();
        }
    });

    $("#paper_marks").on("change",function(e){
        $("#paper_time_section").show();
        var paper_marks=$(this).val();
        if(paper_marks == 8){
            $('#paper_time').val('15 min');
        } else if(paper_marks == 12){
            $('#paper_time').val('45 min');
        } else if(paper_marks == 20){
            $('#paper_time').val('1 hour');
        } else if(paper_marks == 24){
            $('#paper_time').val('1 hour');
        } else if(paper_marks == 25){
            $('#paper_time').val('1.5 hour');
        } else if(paper_marks == 28){
            $('#paper_time').val('75 min');
        } else if(paper_marks == 30){
            $('#paper_time').val('1.5 hour');
        } else if(paper_marks == 40){
            $('#paper_time').val('2 hour');
        } else if(paper_marks == 50){
            $('#paper_time').val('2 hour');
        } else if(paper_marks == 56){
            $('#paper_time').val('2 hour');
        } else if(paper_marks == 60){
            $('#paper_time').val('2.5 hour');
        } else if(paper_marks == 70){
            $('#paper_time').val('2.5 hour');
        } else if(paper_marks == 80) {
            $('#paper_time').val('3 hour');
        } else {
            $('#paper_time').val('');
        }
    });

    $("#board_id, #medium_id, #class_id, #subject_id, #paper_marks").on('change', function(){
        $(this).css('border','2px solid rgba(0, 0, 0, 0.15)');
    });
    ...
    $("#actionDataProcess").on("click", function(){
        ...
        if (err == 1){
            ...
            $.ajax({ 
                url: base_url + "/admin/addsubjectivepaper",
                method:"POST",
                data:form_data,
                dataType:"json",
    ...
    $('#addSubjectivePaper').on('submit', function(event){ 
        event.preventDefault();
        var err = 0;
        var fieldId = '';
