...
Route::any('/admin/addSubject',[SubjectController::class,'addSubject']);
Route::get('/admin/getSubjectAllData',[SubjectController::class,'getSubjectAllData']);
Route::get('/admin/updateGetSubjectData',[SubjectController::class,'updateGetSubjectData']);
Route::delete('/admin/deleteSubjectData',[SubjectController::class,'deleteSubjectData']);
