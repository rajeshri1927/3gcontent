...
! function (a, b) {
    ...
    var p = a.fn.datepicker.dates = {
            ...
            ar: {
                days: ["الأحد", "الاثنين", "يوم الثلاثاء", "الأربعاء", "يوم الخميس", "جمعة", "السبت", "الأحد"],
                daysShort: ["شمس", "الإثنين", "الثلاثاء", "تزوج", "خميس", "الجمعة", "قعد", "شمس"],
                daysMin: ["هم", "شهر", "تو", "نحن", "ذ", "الاب", "على", "هم"],
                months: ["يناير", "شهر فبراير", "يمشي", "أبريل", "يمكن", "يونيو", "يوليو", "أغسطس", "سبتمبر", "اكتوبر", "شهر نوفمبر", "ديسمبر"],
                monthsShort: ["يناير", "فبراير", "مارس", "أبريل", "يمكن", "يونيو", "يوليو", "أغسطس", "سبتمبر", "أكتوبر", "نوفمبر", "ديسمبر"],
                today: "اليوم",
                clear: "واضح"
            }
        },
